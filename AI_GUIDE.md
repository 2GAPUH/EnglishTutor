...
embedVerbs используется в: past-simple (секция «Правильные и неправильные глаголы»), present-perfect (секция «Формулы»), past-perfect (секция «Формулы»), past-perfect-continuous (секция «Формулы»)
...
Блок 2 — Past Tenses
  ...
  past-perfect-continuous     — теория: есть (9 секций), упражнений: 100, подсказок: 25, статус: готово
